...
cat('Citation:\nScotto di Vettimo, M. (2022), "scRapEU: An R function to scrape data on EU laws". Version December 2025. https://michelescottodivettimo.eu/scrapeu/scRapEU.R.\n\n')
cat('NOTE: The function is continously updated. Suggestions, and reports of bugs are welcome.\n')
cat('Last update: 15 December 2025.\n\n')